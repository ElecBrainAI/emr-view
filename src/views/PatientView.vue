...
<!--                          </span>-->
    ...
    <div class="static h-screen flex overflow-hidden">
      ...
      <div class="main-bar w-48 py-4 px-8 bg-gray-100 border-r overflow-auto">
        ...
        <aside id="logo-sidebar" class="fixed top-0 left-0 w-48 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
          <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
            ...
            <ul class="space-y-2 font-medium sidebar">
              ...
              <li class="sidebar-login place-items-end">
