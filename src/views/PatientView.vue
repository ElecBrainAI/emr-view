      ...
      <div class="w-64 py-4 px-8 bg-gray-100 border-r overflow-auto">
        ...
        <div class="flex flex-col flex-1 min-w-0 overflow-hidden">
          <header class="px-6">
            ...
            <!--        </svg>-->
                    <a href="#" class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">환자차트</a>
                  </div>
                </li>
                <li aria-current="page">
                  <div class="flex items-center">
                    ...
                    <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">박은희 환자</span>
                  </div>
                </li>
              </ol>
            </nav>
          ...
          <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
              ...
              <div class="flex flex-col items-center pb-10">
                  <h5 class="mb-1 text-xl font-medium text-gray-900 dark:text-white">박은희</h5>
